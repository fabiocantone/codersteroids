...
Long-running coding work should not blur workspace state. CoderSteroids uses this skill to decide when work needs an isolated branch or worktree, how to preserve provenance, and how to finish the branch without losing verification or project memory.
