...
CoderSteroids should be strict where rigor matters and lightweight where ceremony would slow the work without improving correctness. Use this skill to keep small tasks fast while preserving basic evidence and memory hygiene.
