...
Behavior changes should normally start with a failing test. CoderSteroids uses a pragmatic version of TDD: strict when behavior is testable, explicit when it is not, and always tied to fresh verification.
