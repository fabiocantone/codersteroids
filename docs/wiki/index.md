...
This wiki is the durable memory for the project. Agents should read it before planning and update it after meaningful work.
...
- [Code Standards](code-standards.md): local programming standards and file-size guidance.
- [Open Questions](open-questions.md): unresolved ambiguity and contradictions.
